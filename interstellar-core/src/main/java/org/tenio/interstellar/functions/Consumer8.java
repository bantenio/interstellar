...
@FunctionalInterface
public interface Consumer8<P1, P2, P3, P4, P5, P6, P7, P8> extends Serializable, Invoker {
    ...
    default Object invoke(Object[] args) {
        accept((P1) args[0], (P2) args[1], (P3) args[2], (P4) args[3], (P5) args[4], (P6) args[5], (P7) args[6], (P8) args[7]);
        return null;
    }
