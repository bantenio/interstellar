...
abstract class Dispatcher {
     ...
     */
    abstract void dispatch(Object event,
    ...
    private static final class PerThreadQueuedDispatcher extends Dispatcher {
        ...
        void dispatch(Object event,
                      ...
                      SubscriberExceptionContext subscriberExceptionContext,
                      SubscriberExceptionHandler exceptionHandler) {
            if (ObjectUtil.isAllNotEmpty(event, subscribers)) {
                ...
                try {
                    ...
                    while ((nextEvent = queueForThread.poll()) != null) {
                        while (nextEvent.subscribers.hasNext()) {
                            Subscriber next = nextEvent.subscribers.next();
                            Object eventModel = nextEvent.event;
                            next.dispatchEvent(eventModel, subscriberExceptionContext, exceptionHandler);
                        }
                    }
                } finally {
                    dispatching.remove();
    ...
    private static final class LegacyAsyncDispatcher extends Dispatcher {
        ...
        void dispatch(Object event,
                      ...
                      SubscriberExceptionContext subscriberExceptionContext,
                      SubscriberExceptionHandler exceptionHandler) {
            if (ObjectUtil.isAllEmpty(event)) {
                throw new NullPointerException();
            }
            ...
            while ((e = queue.poll()) != null) {
                e.subscriber.dispatchEvent(e.event, subscriberExceptionContext, exceptionHandler);
            }
        }
    ...
    private static final class ImmediateDispatcher extends Dispatcher {
        ...
        void dispatch(Object event, Iterator<Subscriber> subscribers,
            ...
            while (subscribers.hasNext()) {
                subscribers.next().dispatchEvent(event, subscriberExceptionContext, exceptionHandler);
            }
        }
    }
}
